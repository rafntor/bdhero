/*
 * ListViewAPI - All the Windows SDK structures and imports
 *
...
namespace NativeAPI.Win.User
{
    ...
    public static class ListViewAPI
    {
        ...
        public const int L_MAX_URL_LENGTH = 2048 + 32 + 4;
        ...
        //    if (window == null)
        //        ListViewAPI.LockWindowUpdateInternal(IntPtr.Zero);
        //    else
        //        ListViewAPI.LockWindowUpdateInternal(window.Handle);
        //}
        ...
        ///     back colors.
        /// </remarks>
        public static void SetSelectedColumn(ListView ListView, ColumnHeader value)
        {
...
//        static public IntPtr SetTooltipControl(ListView lv, ToolTip tooltip)
//        {
...
//        }
        ...
        public static int SetGroupInfo(ListView olv, int groupId, LVGROUP2 group)
        {
            return (int) SendMessage(olv.Handle, LVM_SETGROUPINFO, groupId, ref group);
        }

        public static int SetGroupMetrics(ListView olv, int groupId, LVGROUPMETRICS metrics)
        {
            return (int) SendMessage(olv.Handle, LVM_SETGROUPMETRICS, groupId, ref metrics);
        }

//        public static int ClearGroups(VirtualListView virtualListView)
//        {
//            return (int)ListViewAPI.SendMessage(virtualListView.Handle, LVM_REMOVEALLGROUPS, 0, 0);
//        }

        public static int SetGroupImageList(ListView olv, ImageList il)
        {
