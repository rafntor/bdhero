...
namespace NativeAPI.Win.User
{
    ...
    public enum WindowStyles : uint
    {
        ...
        /// <summary>
        ///     The window has a title bar (includes the <see href="WS_BORDER"/> style).
        /// </summary>
        WS_CAPTION = 0x00C00000,

        /// <summary>
        ///     The window is a child window. A window with this style cannot have a menu bar.
        ///     This style cannot be used with the <see href="WS_POPUP"/> style.
        /// </summary>
        WS_CHILD = 0x40000000,

        /// <summary>
        ///     Same as the <see href="WS_CHILD"/> style.
        /// </summary>
        ...
        ///     WM_PAINT message, the <see href="WS_CLIPSIBLINGS"/> style clips all other overlapping child windows
        ///     out of the region of the child window to be updated. If <see href="WS_CLIPSIBLINGS"/> is not specified
        ...
        ///         all controls defined after it, up to the next control with the <see href="WS_GROUP"/> style.
        ///         The first control in each group usually has the <see href="WS_TABSTOP"/> style so that the user
        ...
        /// <summary>
        ///     The window is initially minimized. Same as the <see href="WS_MINIMIZE"/> style.
        /// </summary>
        ...
        /// <summary>
        ///     The window has a maximize button. Cannot be combined with the <see href="ExtendedWindowStyles.WS_EX_CONTEXTHELP"/> style.
        ///     The <see href="WS_SYSMENU"/> style must also be specified.
        /// </summary>
        WS_MAXIMIZEBOX = 0x00010000,

        /// <summary>
        ///     The window is initially minimized. Same as the <see href="WS_ICONIC"/> style.
        /// </summary>
        WS_MINIMIZE = 0x20000000,

        /// <summary>
        ///     The window has a minimize button. Cannot be combined with the <see href="ExtendedWindowStyles.WS_EX_CONTEXTHELP"/> style.
        ///     The <see href="WS_SYSMENU"/> style must also be specified.
        /// </summary>
        ...
        ///     Same as the <see href="WS_TILED"/> style.
        /// </summary>
        WS_OVERLAPPED = 0x00000000,

        /// <summary>
        ///     The window is an overlapped window. Same as the <see href="WS_TILEDWINDOW"/> style.
        /// </summary>
        WS_OVERLAPPEDWINDOW = (WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_THICKFRAME | WS_MINIMIZEBOX | WS_MAXIMIZEBOX),

        /// <summary>
        ///     The windows is a pop-up window. This style cannot be used with the <see href="WS_CHILD"/> style.
        /// </summary>
        WS_POPUP = 0x80000000,

        /// <summary>
        ///     The window is a pop-up window. The <see href="WS_CAPTION"/> and <see href="WS_POPUPWINDOW"/> styles
        ///     must be combined to make the window menu visible.
        /// </summary>
        WS_POPUPWINDOW = (WS_POPUP | WS_BORDER | WS_SYSMENU),

        /// <summary>
        ///     The window has a sizing border. Same as the <see href="WS_THICKFRAME"/> style.
        /// </summary>
        WS_SIZEBOX = 0x00040000,

        /// <summary>
        ///     The window has a window menu on its title bar. The <see href="WS_CAPTION"/> style must also be specified.
        /// </summary>
        ...
        ///         Pressing the TAB key changes the keyboard focus to the next control with the <see href="WS_TABSTOP"/> style.
        ///     </para>
        ///     <para>
        ...
        /// <summary>
        ///     The window has a sizing border. Same as the <see href="WS_SIZEBOX"/> style.
        /// </summary>
        WS_THICKFRAME = 0x00040000,

        /// <summary>
        ///     The window is an overlapped window. An overlapped window has a title bar and a border.
        ///     Same as the <see href="WS_OVERLAPPED"/> style.
        /// </summary>
        WS_TILED = 0x00000000,

        /// <summary>
        ///     The window is an overlapped window. Same as the <see href="WS_OVERLAPPEDWINDOW"/> style.
        /// </summary>
