...
namespace NativeAPI.Win.User
{
    ...
    public static class ExtendedWindowStylesExtensions
    {
        public static Int32 ToInt32(this ExtendedWindowStyles extendedWindowStyles)
        {
            return (Int32) extendedWindowStyles;
        }
