...
namespace NativeAPI.Win.User
{
    ...
    public enum ShowWindowCommand
    {
        ...
        ///     to its original size and position. An application should specify this flag when restoring a minimized window.
        /// </summary>
        SW_RESTORE = 9,
        ...
        /// <summary>
        ///     Sets the show state based on the value specified in the <c>STARTUPINFO</c> structure passed to the
        ///     <c>CreateProcess</c> function by the program that started the application.
        /// </summary>
        SW_SHOWDEFAULT = 10,
