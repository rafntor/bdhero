...
{
    /// <summary>
    ///     Promise whose <see href="IPromise{TResult}.Result"/> value is irrelevant.
    /// </summary>
    public class EmptyPromise : Promise<Nil>
    {
        /// <summary>
        ///     Constructs a new <see href="EmptyPromise"/> instance that invokes callback event handlers on
